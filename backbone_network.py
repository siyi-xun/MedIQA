...
from prompt_driven_STL import SwinTransformer
...
class Backbone(nn.Module):
    def __init__(self, embed_dim=768, num_outputs=1, patch_size=8, drop=0.1,
        ...
        self.MLP1 = nn.Linear(64, 768)
        self.MLP2 = nn.Linear(64, 384)
    ...
    def forward(self, x, info):
        ...
        info1 = self.MLP1(info)
        info2 = self.MLP2(info)
        ...
        x = self.conv1(x)
        x = self.swintransformer1(x, info1)
        ...
        x = self.conv2(x)
        x = self.swintransformer2(x, info2)
